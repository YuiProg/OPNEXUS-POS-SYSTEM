...
const { setYesNoSettingsApply, setYesNoSettingsReset, setInputs, inputs } =
...
//     this.setState({
//       categorySettings: settingsProps.categorySettings?.enabled === true ? 'ACTIVE' : 'INACTIVE'
//     })
//   }
    ...
    return (
      <div className="settings-content">
        ...
        <InputRow titles={['Enable']}>
          <Toggle
            hideLabel
            isChecked={settingsProps.categorySettings?.enabled}
            onToggle={(value) => setInputs('categoryEnabled', value === 'ACTIVE' ? true : false)}
          />
        </InputRow>
    ...
    return (
      <div className="settings-content">
        ...
        <InputRow titles={['Enable']}>
          <Toggle
            hideLabel
            isChecked={settingsProps.vipManagementSettings?.enabled}
            onToggle={(value) => setInputs('vipEnabled', value === 'ACTIVE' ? true : false)}
          />
        </InputRow>
  ...
  staffPanel = () => {
    ...
    return (
      <div className="settings-content">
        ...
        <InputRow titles={['Enable']}>
          <Toggle
            isChecked={settingsProps.staffManagementSettings?.enabled}
            hideLabel
            onToggle={(value) => setInputs('staffEnabled', value === 'ACTIVE' ? true : false)}
          />
        </InputRow>
    ...
    return (
      <div className="settings-content">
        ...
        <InputRow titles={['Enable']}>
          <Toggle
            hideLabel
            onToggle={(value) => setInputs('branchEnabled', value === 'ACTIVE' ? true : false)}
          />
        </InputRow>
        ...
        <div className="settings-container">
          ...
          <div className="settings-main">
            ...
            <div className="settings-actions">
              ...
              <Button text="Apply Changes" error onClick={() => setYesNoSettingsApply(true)} />
            </div>
          </div>
        </div>
      </PanelPage>
