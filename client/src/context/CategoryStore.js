...
const CategoryStore = create((set, get) => ({
    ...
    getCategories: async () => {
        try {
            ...
            const cleanedData = categoriesData.map(({_id, __v, updatedAt, createdById, createdAt, ...rest}) => ({
                ...rest,
    ...
    deleteCategory: async () => {
        ...
        try {
            const res = await axiosInstance.post(DELETECATEGORY.replace(':id', selectedItem.Id));
